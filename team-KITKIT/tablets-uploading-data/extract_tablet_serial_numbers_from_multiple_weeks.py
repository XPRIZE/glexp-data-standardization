...
#
# The extracted data will be stored in a file named `tablets-uploading-data-KITKIT.csv`.
...
print(os.path.basename(__file__), "Writing data to \"tablets-uploading-data-KITKIT.csv\"...")
with open('tablets-uploading-data-KITKIT.csv', 'w') as outfile:
    infile_count = 0
    for week_end_date in data_collection_week_end_dates:
        print(os.path.basename(__file__), "\n\n"
                                          "**********\n")
        csv_filename_weekly = "tablets-uploading-data-KITKIT_" + week_end_date + ".csv"
        ...
        with open(csv_filename_weekly) as infile:
            ...
            for line in infile:
                ...
                infile_row_count += 1
        infile_count += 1
print(os.path.basename(__file__), "Writing data to \"tablets-uploading-data-KITKIT.csv\" complete!")
