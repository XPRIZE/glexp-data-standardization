...
# Data was not collected between 2017-12-22 and 2018-05-11 due to technical issues.
...
print(os.path.basename(__file__), "Writing data to \"tablets-uploading-data-CCI.csv\"...")
with open('tablets-uploading-data-CCI.csv', 'w') as outfile:
    infile_count = 0
    for week_end_date in data_collection_week_end_dates:
        print(os.path.basename(__file__), "\n\n"
                                          "**********\n")
        csv_filename_weekly = "tablets-uploading-data-CCI_" + week_end_date + ".csv"
        ...
        with open(csv_filename_weekly) as infile:
            ...
            for line in infile:
                ...
                infile_row_count += 1
        infile_count += 1
print(os.path.basename(__file__), "Writing data to \"tablets-uploading-data-CCI.csv\" complete!")
